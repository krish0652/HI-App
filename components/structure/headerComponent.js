            ...
            <View style={headerStyles.container}>
                <View style={headerStyles.row}>
                    <View style={headerStyles.headerText}>
                        <Text style={headerStyles.headerParts}>HomeInspe</Text>
                        <Text style={[headerStyles.error, headerStyles.headerParts]}>K</Text>
                        <Text style={headerStyles.headerParts}>tor</Text>
                    </View>
